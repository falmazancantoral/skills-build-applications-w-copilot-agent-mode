            ...
            <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '60vh' }}>
              <div className="card shadow" style={{ maxWidth: '28rem', width: '100%' }}>
                <div className="card-body text-center">
                  ...
                  <h1 className="card-title display-5 mb-3">Bienvenido a OctoFit Tracker</h1>
                  <p className="card-text lead">¡Comienza a registrar tus actividades!</p>
                  <a href="/activities" className="btn btn-primary mt-3">Ver Actividades</a>
                </div>
              </div>
            </div>
          } />
